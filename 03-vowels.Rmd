...
We will work with examples from Abaza ([sound](https://github.com/agricolamz/2022_HSE_m_Instrumental_phonetics/blob/master/sounds/abaza_vowels.wav?raw=true), [TextGrid](https://raw.githubusercontent.com/agricolamz/2022_HSE_m_Instrumental_phonetics/master/sounds/abaza_vowels.TextGrid), press `Ctrl+S` in order to save the Text.Grid):
